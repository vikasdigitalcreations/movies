...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::addons::addon_catalogs,
            commands::addons::addon_catalog_items,
            commands::adult::adult_search,
            commands::adult::adult_playback,
            commands::adult::adult_set_enabled,
            commands::adult::adult_is_enabled,
            commands::system::pin_is_set,
            commands::system::pin_set,
            commands::system::pin_verify,
            commands::system::pin_clear,
            commands::system::addon_set_locked,
