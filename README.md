...
Built around the open-source terminal app [MovieBox-Tui](https://github.com/mesamirh/MovieBox-Tui) v0.1.21, which is vendored in `vendor/moviebox-tui` and reused for all catalog, stream, download, history and favorites logic. This project replaces its terminal interface with a Netflix-style desktop UI.
